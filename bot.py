...
history = {
    "R32": (
        "🏎 R32 GT-R (1989–1994)\n\n"
        "Возрождение GT-R как гоночной машины под Group A.\n\n"
        "🏁 29 побед подряд в JTCC\n"
        "🔧 RB26DETT + ATTESA E-TS + HICAS\n"
        "⚙️ Реально мощнее заявленных 280 л.с.\n\n"
        "👑 Прозвище: Godzilla"
    ),
    ...
    "R33": (
        ...
        "🏁 Nürburgring < 8 минут\n"
        "🔧 ATTESA E-TS Pro + новая подвеска\n"
    ...
    "R34": (
        "🏎 R34 GT-R (1999–2002)\n\n"
        "Финальная версия Skyline GT-R, компактнее и технологичнее.\n\n"
        "🏁 Культовый статус\n"
        "🔧 Экран телеметрии + полный привод\n"
        "⚙️ Популярность благодаря Fast & Furious\n\n"
        "👑 Икона JDM"
    ),

    "R35": (
        "🏎 GT-R R35 (2007–)\n\n"
        "Полностью новая модель, больше не Skyline.\n\n"
...
car_facts = {
    "R32": [
        "🏁 29 побед подряд — доминирование",
        "👾 Прозвище Godzilla из Австралии",
        "⚙️ Мощность занижалась официально",
        "🔧 Тюнинг до 1000+ л.с.",
        "🧠 Умный полный привод ATTESA"
    ],

    "R33": [
        "🏁 Первый <8 мин Nürburgring",
        "⚖️ Быстрее R32 на треке",
        "🔧 Версия LM для Ле-Мана",
        "🧠 ATTESA Pro распределяет тягу",
    ...
    "R34": [
        "🎬 Икона Fast & Furious",
        "🖥 Экран телеметрии",
        "🔥 V-Spec II редкая версия",
        "💰 Цена сильно выросла",
        "🧠 Отличный баланс для трека"
    ],

    "R35": [
        "🧑‍🔧 Двигатель собирает мастер Takumi",
        "🚀 Быстрее многих суперкаров",
        "🏁 Рекорды Nürburgring",
        "💻 Полностью электронное управление",
        "🔥 Мощность выросла до 600+ л.с."
    ]
}
